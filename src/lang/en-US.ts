export default {
  ...
  actions: { create: 'Create', update: 'Update', edit: 'Edit' },
  datetime: {
  ...
  user: {
    'see-info': 'See information',
  },
  tasks: {
    all: 'All tasks',
    completed: 'Tasks was completed',
    deleted: 'Tasks was deleted',
    noTasks: 'There are no tasks here!',
  },
  auth: {
    login: 'Login',
    logout: 'Logout',
    ...
    haveNotAnAccount: "Haven't an account?",
  },
  request: {
    response: {
  ...
  validate: {
    ...
    min: 'This field must be at least {0} character | This field must be at least {1} character',
